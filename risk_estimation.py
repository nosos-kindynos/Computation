...
def estimate_risk(sources, target, mapping, risk_mapping,accuracy,top):
    ...
    def calculate_risk():
        ...
        for source in sources:
            ...
            paths.extend(find_all_possible_paths(source, relative_mapping))
    ...
    def find_all_possible_paths(source,mapping): 
